...
void Migrations::migrateV3()
{
    ...
    QString location = rootLocation + "/files/.config/RampageVPN.ORG/RampageVPN.conf";
    ...
    if (oldConfig.exists()) {
        ...
        QFile newConfigFile(newConfigPath + "/RampageVPN.conf");
        ...
        if (!newConfigFile.exists()) {
            ...
            if (cpResult) {
                ...
                oldConfigDir.rmdir("RampageVPN.ORG");
            }
        }
    }
#endif
