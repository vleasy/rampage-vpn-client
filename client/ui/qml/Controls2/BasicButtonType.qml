...
Button {
    ...
    property string hoveredColor: RampageStyle.color.lightGray
    property string defaultColor: RampageStyle.color.paleGray
    property string disabledColor: RampageStyle.color.charcoalGray
    property string pressedColor: RampageStyle.color.mutedGray

    property string textColor: RampageStyle.color.midnightBlack

    property string borderColor: RampageStyle.color.paleGray
