...
set_target_properties(${PROJECT} PROPERTIES
    ...
    MACOSX_BUNDLE_INFO_STRING "RampageVPN"
    MACOSX_BUNDLE_BUNDLE_NAME "RampageVPN"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "RampageVPN"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "RampageVPN"
    ...
    XCODE_EMBED_APP_EXTENSIONS RampageVPNNetworkExtension
)
...
if(DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr macos.org.Rampage.RampageVPN"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev macos.org.Rampage.RampageVPN"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_ATTRIBUTE_SWIFT_OBJC_INTERFACE_HEADER_NAME "RampageVPN-Swift.h"
...
set(WG_APPLE_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/3rd/Rampagewg-apple/Sources)
...
add_dependencies(${PROJECT} RampageVPNNetworkExtension)
...
add_custom_command(TARGET ${PROJECT} POST_BUILD
    COMMAND ${QT_BIN_DIR_DETECTED}/macdeployqt $<TARGET_BUNDLE_DIR:RampageVPN> -appstore-compliant -qmldir=${CMAKE_CURRENT_SOURCE_DIR} -no-codesign
)
